...
# Project title.
title = "CSE508: Network Security - Fall 2018"
...
Paper responses are **due before the start of class** via the [online submission system](https://stonybrook-cse508-fall18.hotcrp.com/). For each submission, **use the paper name as the title** and **write your review in the abstract box**.
...
# Design Challenge
Have you ever been frustrated with a particular system and wished it had done something differently? Well now it's the time to make it so!
...
## The Problem
The problem you pick can be something very practical or completely out of the box!
...
- What is the benefit of your idea?
