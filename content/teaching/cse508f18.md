...
# Design Challenge
Have you ever been frustrated with a particular system and wished it would do something differently? Well now it's the time to make it so! In the design challenge, we want you to tackle a problem that you see in the security domain, and come up with efficient and creative ways of addressing it.
